...
const SevenPillarsSection: React.FC = () => {
  ...
  return (
    <section className="relative z-70 bg-gradient-to-b from-[#F2F8F6] to-[#D8EEE7] py-[124px] px-4 sm:px-6 lg:px-8">
      <div className="max-w-[1520px] mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray max-w-4xl mx-auto poppins-regular">
