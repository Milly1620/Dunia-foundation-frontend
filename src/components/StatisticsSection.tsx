...
const StatisticsSection: React.FC = () => {
  return (
    <section className="sticky top-0 z-60 bg-white py-[40px] flex items-center justify-center">
      <div className="w-full max-w-[1020px] px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-8 lg:gap-15">
