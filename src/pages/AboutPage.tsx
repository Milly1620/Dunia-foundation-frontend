...
import aboutpagemobilepath from "../assets/aboutpathsvg.svg";
      ...
      <div className="w-full bg-gradient-to-b from-tertiary to-secondary">
        ...
        <div className="relative w-full">
          ...
          <div className="relative">
            ...
            />
            <div className=" absolute z-50 top-[150px] text-center px-4 text-white">
              <h1 className="text-2xl poppins-bold mb-6">
